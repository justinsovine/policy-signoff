import { User as UserType, Policy as PolicyType, SignoffEntry as SignoffEntryType } from "@/types";
...
function SignoffSummary() {
  const tableData: SignoffEntryType[] = [
    { 
      user: "Alice Thompson",
            ...
            <div className="grid sm:grid-cols-12 gap-2 sm:gap-4 px-5 py-3.5 border-b border-zinc-100 items-center">
              ...
              <div className="sm:col-span-3">
                <span className="text-sm text-zinc-500">
                  {data.signed_at ? data.signed_at : '&emdash;'}
                </span>
              </div>
            </div>
          })}
